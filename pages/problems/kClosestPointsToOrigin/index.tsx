...
export default function KClosestPointsToOrigin() {
  return (
    <Layout>
      <Heading>k Closest Points To Origin</Heading>
      <Text>
        ...
        Euclidean distance (i.e., √(x1 - x2)2 + (y1 - y2)2). You may return the
        answer in any order. The answer is guaranteed to be unique (except for
